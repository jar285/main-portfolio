...
### Status Component
- **Implementation**: Created `StatusIndicator` with a green pulsing dot (`bg-success`) and specific status text: *"Building AI-powered tools at YU & Associates"*.
...
*Desktop Navbar with Status Indicator and pulsing dot.*
...
*Project Card exhibiting vertical lift and golden border glow.*
...
*Mobile Menu panel at 320px with integrated Status Indicator.*
...
*Floating Back-to-Top button appearing after 400px scroll.*
